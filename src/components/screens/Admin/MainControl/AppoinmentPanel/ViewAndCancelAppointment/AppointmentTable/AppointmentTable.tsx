...
class AppointmentTable extends React.Component<any, any> {
  ...
  performSelectAppointment = (appt: any) => () =>
    this.props.selectAppointment(appt);
  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        id: "appt-date",
        Header: "Appt Date",
        accessor: (d: { apptDate: number }) =>
          new Date(d.apptDate * 1000).toLocaleDateString("en-US")
      },
      {
        id: "from",
        Header: "From",
      ...
      },
      {
        id: "subject",
        Header: "Subject",
        accessor: (d: { subject: { label: string; full: string } }) =>
          `${d.subject.label} - ${d.subject.full}`
      },
      {
        id: "tutor",
        Header: "Tutor",
    ...
    return (
      <div style={{ width: "100%", height: 688 }}>
        <ReactTable
          style={{ width: "100%", height: "100%" }}
          columns={columns}
          data={this.props.data}
          showPagination={false}
          pageSize={this.props.data.length <= 17 ? 17 : this.props.data.length}
...
export default connect(
  mapStateToProps,
  { fetchAllAppointments, selectAppointment }
)(AppointmentTable);
