...
import { fetchAllAppointments, clearStore } from 'redux/store/appointment/action';
...
export default connect(null, { fetchAllAppointments, clearStore })(ReportAppointmentTable);
